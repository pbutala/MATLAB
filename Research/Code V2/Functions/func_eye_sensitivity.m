function [ V ] = func_eye_sensitivity( min, max, del, CIE )
%FUNC_EYE_SENSITIVITY Produces a curve of the V eye sensitivity function
...
%   E.F. Schubert - Appendix 16.1.  Intermediate values are approximated.
  ...
  %This function needs to be updated if delta lambda is not 1
  if (del > 1)
    V=0;
    return
  end
