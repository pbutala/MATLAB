...
switch fSTATION
    case 1
        ctFileCodeSrcNI = '\\ad\eng\users\p\b\pbutala\My Documents\MATLAB\Research\Code V2\Scripts\scrOSM_ofdm_NI.m';
    case 2
        ctFileCodeSrcNI = '/home/pbutala/My Documents/MATLAB/Research/Code V2/Scripts/scrOSM_ofdm_NI.m';
    case 3
        ctFileCodeSrcNI = 'C:\\Users\\pbutala\\My Documents\\MATLAB\\Research\\Code V2\\Scripts\\scrOSM_ofdm_NI.m';
    otherwise
...
STRPREFIXNI = 'SIM_2ni_';
CHARIDXARCHIVENI = '';

% STATION
switch fSTATION
    case 1
        ctDirRes = '\\ad\eng\users\p\b\pbutala\My Documents\MatlabResults\10. OSM OFDM all\';
        ctFileCodeSrc = '\\ad\eng\users\p\b\pbutala\My Documents\MATLAB\Research\Code V2\Scripts\scrOSM_ofdm.m';
        ctDirResNI = '\\ad\eng\users\p\b\pbutala\My Documents\MatlabResults\10. OSM OFDM NI\';
    case 2
        ctDirRes = '/home/pbutala/My Documents/MatlabResults/10. OSM OFDM all/';
        ctFileCodeSrc = '/home/pbutala/My Documents/MATLAB/Research/Code V2/Scripts/scrOSM_ofdm.m';
        ctDirResNI = '/home/pbutala/My Documents/MatlabResults/10. OSM OFDM NI/';
    case 3
        ctDirRes = 'C:\\Users\\pbutala\\Documents\\MatlabResults\\10. OSM OFDM all\\';
        ctFileCodeSrc = 'C:\\Users\\pbutala\\My Documents\\MATLAB\\Research\\Code V2\\Scripts\\scrOSM_ofdm.m';
        ctDirResNI = 'C:\\Users\\pbutala\\Documents\\MatlabResults\\10. OSM OFDM NI\\';
    otherwise
        error('Station not defined');
end
ctFileCodeDest = [ctDirRes STRPREFIX 'scrOSM_ofdm' CHARIDXARCHIVE '.m'];
ctFileCodeDestNI = [ctDirRes STRPREFIX 'scrOSM_ofdm_NI' CHARIDXARCHIVENI '.m'];
ctFileVars = [ctDirRes STRPREFIX 'matOSM_ofdm' CHARIDXARCHIVE '.mat'];      % file to store workspace
...
%             semilogy(gca,rngSNRdb,bit_err(:,iM,iOfdm,iOfst),plStyle);
            semilogy(gca,Xc,power(10,Yc),plStyle);
            ...
            title(tStr);
            grid on;
            axis([rngSNRdb(1) rngSNRdb(end) BERTH/5 1]);
