...
switch fSTATION
    case 1
        ctDirRes = '\\ad\eng\users\p\b\pbutala\My Documents\MatlabResults\10. OSM OFDM NI\';
        ctFileCodeSrc = '\\ad\eng\users\p\b\pbutala\My Documents\MATLAB\Research\Code V2\Scripts\scrOSM_ofdm_NI.m';
    case 2
        ctDirRes = '/home/pbutala/My Documents/MatlabResults/10. OSM OFDM NI/';
        ctFileCodeSrc = '/home/pbutala/My Documents/MATLAB/Research/Code V2/Scripts/scrOSM_ofdm_NI.m';
    case 3
        ctDirRes = 'C:\\Users\\pbutala\\Documents\\MatlabResults\\10. OSM OFDM NI\\';
        ctFileCodeSrc = 'C:\\Users\\pbutala\\My Documents\\MATLAB\\Research\\Code V2\\Scripts\\scrOSM_ofdm_NI.m';
    otherwise
        error('Station not defined');
end
ctFileCodeDest = [ctDirRes STRPREFIX 'scrOSM_ofdm_NI' CHARIDXARCHIVE '.m'];
ctFileVars = [ctDirRes STRPREFIX 'matOSM_ofdm_NI' CHARIDXARCHIVE '.mat'];      % file to store workspace
...
%%% OSM
rngSNRdb = [150:1:275 276:0.1:350];
% rngSNRdb = [200 400];
