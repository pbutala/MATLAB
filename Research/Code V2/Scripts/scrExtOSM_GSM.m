...
switch fSTATION
    case 1
        ctDirRes = '\\ad\eng\users\p\b\pbutala\My Documents\MATLAB\Research\Code V2\Results\5. Ext OSM GSM\';
        ctFileCodeSrc = '\\ad\eng\users\p\b\pbutala\My Documents\MATLAB\Research\Code V2\Scripts\scrExtOSM_GSM.m';
    case 2
        ctDirRes = '/home/pbutala/My Documents/MATLAB/Research/Code V2/Results/5. Ext OSM GSM/';
        ctFileCodeSrc = '/home/pbutala/My Documents/MATLAB/Research/Code V2/Scripts/scrExtOSM_GSM.m';
    case 3
        ctDirRes = 'C:\\Users\\pbutala\\Documents\\MATLAB\\Research\\Code V2\\Results\\5. Ext OSM GSM\\';
        ctFileCodeSrc = 'C:\\Users\\pbutala\\Documents\\MATLAB\\Research\\Code V2\\Scripts\\scrExtOSM_GSM.m';
    otherwise
        error('Station not defined');
end
ctFileCodeDest = [ctDirRes 'scrExtOSM_gSM' CHARIDXARCHIVE '.m'];
ctFileVars = [ctDirRes 'ExtOSM_gSM' CHARIDXARCHIVE '.mat'];      % file to store workspace
...
for iMI = 1:lenMI
    ...
    for iNtM = 1:nNtM
        ...
        clLgd{iLgd} = sprintf('gSM: N_{t}=%0.0f,M=%0.0f\n%0.0f b/sym',Nt,M,obpS(iNtM));
        iLgd = iLgd + 1;
    end
    %     end
    % end
